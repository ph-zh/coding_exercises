...
Она считает время на доставку и предлагает заказ свободному курьеру. На дистанции более 10 км отправляются курьеры на машинах,
на дистанции менее 2 км курьеры-пешеходы, остальные заказы выполняют курьеры-велосипедисты. Автор программы что-то напутал
с областями видимости переменных. Исправьте код программы, чтобы она работала корректно.
 */
